from amatsukaze_client.model.rpc.message import AmatsukazeRPCMessage, from_bytes, from_messages_bytes
...
def test_from_messages_bytes_success():
    actual = list(from_messages_bytes(b'\x0a\x00\x00\x00test bytes\x0c\x00\x00\x00second bytes'))
